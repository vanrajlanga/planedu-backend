...
\restrict EWNDLzvc6G7NT5QWAQCY5SAMK1SRqazRDK9CrrRfHdtXq4hwfNPaitdvwXF1Irv
...
--
-- Data for Name: content_authors; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.content_authors (id, name, slug, email, profile_image_url, designation, bio, is_verified, status, created_at, updated_at) FROM stdin;
1	Admin Writer	admin-writer	admin@planedu.com	\N	Content Manager	\N	t	active	2025-12-30 16:43:28.485409	2025-12-30 16:43:28.485409
2	Priya Sharma	priya-sharma	priya@planedu.com	\N	Senior Content Specialist	Education content specialist with 5+ years experience	f	active	2025-12-30 17:02:54.569964	2025-12-30 17:02:54.569964
\.
...
1	btech	B.Tech Colleges in India 2028	<h1>Test Content</h1><p>This is a test paragraph. 😄</p>	\N			published	2026-01-01 22:32:02.440137	2026-01-02 16:03:33.40449	[]
\.
...
SELECT pg_catalog.setval('public.admin_audit_logs_log_id_seq', 422, true);
...
SELECT pg_catalog.setval('public.admin_sessions_session_id_seq', 31, true);
...
SELECT pg_catalog.setval('public.college_content_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.college_gallery_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.college_rankings_ranking_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.college_updates_id_seq', 1, true);
...
--
-- Name: content_authors_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.content_authors_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.course_location_content_content_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.course_page_content_content_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.courses_course_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.exam_cutoffs_cutoff_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.faculty_members_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.placement_recruiters_id_seq', 2, true);
...
--
-- Name: content_authors content_authors_slug_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_content_authors_slug; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_content_authors_slug ON public.content_authors USING btree (slug);


--
-- Name: idx_content_authors_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_content_authors_status ON public.content_authors USING btree (status);
...
--
-- Name: content_authors update_content_authors_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_content_authors_updated_at BEFORE UPDATE ON public.content_authors FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: college_content college_content_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.college_content
    ADD CONSTRAINT college_content_author_id_fkey FOREIGN KEY (author_id) REFERENCES public.content_authors(id) ON DELETE SET NULL;
...
--
-- Name: course_location_content course_location_content_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.course_location_content
    ADD CONSTRAINT course_location_content_author_id_fkey FOREIGN KEY (author_id) REFERENCES public.content_authors(id);
...
\unrestrict EWNDLzvc6G7NT5QWAQCY5SAMK1SRqazRDK9CrrRfHdtXq4hwfNPaitdvwXF1Irv
