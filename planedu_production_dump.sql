...
\restrict QVgjdyhR4pQAktObCOLgjmAc0QP8a09i6Ofg1wC7IWSD8ebl039di945b7RDWhN
...
1	2	1	2025	Engineering	2	89.50	2025-12-30 17:55:32.843631
\.
...
SELECT pg_catalog.setval('public.admin_audit_logs_log_id_seq', 376, true);
...
SELECT pg_catalog.setval('public.admin_sessions_session_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.college_rankings_ranking_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.exam_cutoffs_cutoff_id_seq', 1, true);
...
\unrestrict QVgjdyhR4pQAktObCOLgjmAc0QP8a09i6Ofg1wC7IWSD8ebl039di945b7RDWhN
